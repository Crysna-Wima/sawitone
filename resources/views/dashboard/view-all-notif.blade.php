...
$dateRecent = \Carbon\Carbon::now()->subDays(1)->toDateTimeString();
...
$dateEarlier = \Carbon\Carbon::now()->subDays(1)->toDateTimeString();
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                @endphp
                <a href="{{ $notif->fv_link }}" class="notif-content handle-notification" data-notificationCode="{{ $notif->fc_notificationcode }}">
