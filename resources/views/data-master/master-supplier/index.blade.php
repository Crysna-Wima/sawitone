...
<script>
   ...
   var tb = $('#tb').DataTable({
      ...
      columns: [
         ...
         { data: 'supplier_legal_status.fv_description', defaultContent: '' },
         ...
         { data: 'supplier_nationality.fv_description', defaultContent: '', },
         { data: 'fc_supplierforex' },
         { data: 'supplier_type_business.fv_description', defaultContent: '', },
         { data: 'fl_supplierreseller' },
         { data: 'supplier_tax_code.fv_description', defaultContent: '', },
         ...
         { data: 'supplier_bank1.fv_bankname', defaultContent: '', },
         { data: 'supplier_bank2.fv_bankname', defaultContent: '', },
         { data: 'supplier_bank3.fv_bankname', defaultContent: '', },
