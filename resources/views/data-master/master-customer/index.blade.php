    ...
    <div class="modal fade" role="dialog" id="modal" data-keyboard="false" data-backdrop="static"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <input type="text" class="form-control required-field" name="fc_branch_view" id="fc_branch_view"
                    value="{{ auth()->user()->fc_branch }}" readonly hidden>
                <form id="form_submit" action="/data-master/master-customer/store-update" method="POST"
                    autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6" hidden>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required-field" name="fc_divisioncode"
                                        id="fc_divisioncode" value="{{ auth()->user()->fc_divisioncode }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required-field" readonly
                                        name="fc_membercode" id="fc_membercode">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Customer Name 1</label>
                                    <input type="text" class="form-control required-field" name="fc_membername1"
                                        id="fc_membername1">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membername2"
                                        id="fc_membername2">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="fc_memberaddress1" id="fc_memberaddress1"
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="fc_memberaddress2" id="fc_memberaddress2"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="fc_memberaddress_loading1" id="fc_memberaddress_loading1"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="fc_memberaddress_loading2" id="fc_memberaddress_loading2"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2 required-field" name="fc_memberlegalstatus"
                                        id="fc_memberlegalstatus"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label>Customer Nationality</label>
                                    <select class="select2" name="fc_membernationality" id="fc_membernationality"
                                        onchange="change_nationality()"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label>Customer Forex</label>
                                    <input type="text" readonly class="form-control" name="fc_memberforex"
                                        id="fc_memberforex">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2 required-field" name="fc_membertypebusiness"
                                        id="fc_membertypebusiness"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label>Customer Join Date</label>
                                    <input type="text" class="form-control datepicker" name="fd_memberjoindate"
                                        id="fd_memberjoindate">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item" style="margin: 0!important">
                                            <input type="radio" name="fl_membercontract" value="T"
                                                class="selectgroup-input">
                                            <span class="selectgroup-button">YES</span>
                                        </label>
                                        <label class="selectgroup-item" style="margin: 0!important">
                                            <input type="radio" name="fl_membercontract" value="F"
                            ...
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item" style="margin: 0!important">
                                            <input type="radio" name="fl_memberreseller" value="T"
                                                class="selectgroup-input">
                                            <span class="selectgroup-button">Active</span>
                                        </label>
                                        <label class="selectgroup-item" style="margin: 0!important">
                                            <input type="radio" name="fl_memberreseller" value="F"
                                                class="selectgroup-input" checked="">
                            ...
                            <div class="col-12 col-md-3 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="select2" class="form-control required-field"
                                        name="fc_member_branchtype" id="fc_member_branchtype"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membernpwp_name"
                                        id="fc_membernpwp_name">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Customer NPWP Address 1</label>
                                    <textarea type="text" class="form-control" name="fc_member_npwpaddress1" id="fc_member_npwpaddress1"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="fc_member_npwpaddress2" id="fc_member_npwpaddress2"
                                        style="height: 100px"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberemail1"
                                        id="fc_memberemail1">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberemail2"
                                        id="fc_memberemail2">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberphone1"
                                        id="fc_memberphone1">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberphone2"
                                        id="fc_memberphone2">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberphone3"
                                        id="fc_memberphone3">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="fc_memberbank1"
                                        id="fc_memberbank1"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Customer Bank 2</label>
                                    <select class="form-control select2" name="fc_memberbank2"
                                        id="fc_memberbank2"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Customer Bank 3</label>
                                    <select class="form-control select2" name="fc_memberbank3"
                                        id="fc_memberbank3"></select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membernorek1"
                                        id="fc_membernorek1">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membernorek2"
                                        id="fc_membernorek2">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membernorek3"
                                        id="fc_membernorek3">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_membervirtualac"
                                        id="fc_membervirtualac">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label>Customer Hutang</label>
                                    <input type="text" class="form-control" readonly name="fm_memberAP"
                                        id="fm_memberAP" value="0">
                                </div>
                            </div>
                            <div class="col-12 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label>Customer Aging AP</label>
                                    <input type="number" class="form-control" name="fn_memberAgingAP"
                                        id="fn_memberAgingAP">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="fc_memberlockTransType"
                                        id="fc_memberlockTransType"></select>
                                </div>
                            </div>
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="form-group">
