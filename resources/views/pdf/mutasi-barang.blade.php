...
<body>
    ...
    <div class="content">
        <p style="text-align: center; font-weight:bold; font-size:15px;">MUTASI BARANG</p>
        <br>
        ...
        <table style="width: 92%; border-collapse: collapse; margin: auto;" class="no-space">
            <tr>
                <td>Lokasi Awal</td>
                <td style="width: 5px">:</td>
                <td style="width: 28%">{{ $mutasi_mst->warehouse_start->fc_rackname }}</td>
                <td>Lokasi Tujuan</td>
                <td style="width: 5px">:</td>
                <td style="width: 28%" colspan="1">{{ $mutasi_mst->warehouse_destination->fc_rackname }}</td>
            </tr>
            <tr>
                <td>Alamat Lokasi Awal</td>
                <td style="width: 5px">:</td>
                <td style="width: 28%">{{ $mutasi_mst->warehouse_start->fc_warehouseaddress }}</td>
                <td>Alamat Lokasi Tujuan</td>
                <td style="width: 5px">:</td>
                <td style="width: 28%" colspan="1">{{ $mutasi_mst->warehouse_destination->fc_warehouseaddress }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%;   margin: auto; dashed black; cellspacing=15 page-break-before:always page-break-after:always">
            <br><br/>
            <tr>
                <td style="text-align: right;">Telah dikirim oleh,</td>
            </tr>
            <tr >
