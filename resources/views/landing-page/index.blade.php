...
<body data-theme-mode-panel-active data-theme="light" style="font-family: 'Mazzard H';">
  ...
  <header class="site-header site-header--menu-center dark-mode-texts site-header--absolute">
      <div class="container">
        <nav class="navbar site-navbar">
          <!-- Brand Logo-->
          <div class="brand-logo">
              <img src="{{ asset('assets/img/logo-dexa-white.png') }}" width="160">
          </div>
        </nav>
      </div>
    </header>
          ...
          <div class="col">
            <div class="footer-widget widget1">
              <p class="widget-title">About Us</p>
                <h6>PT. Dexa Arfindo Pratama adalah perusahaan yang difokuskan sebagai distributor alat kesehatan di bidang diagnosa yang memiliki kualitas dan akurat.</h6>
            </div>
          </div>
          <div class="col">
            <div class="footer-widget widget2">
              <p class="widget-title">Contact</p>
                <h6><i class="fas fa-home"></i>&nbsp;Jl. Raya Jemursari No.329-331, Sidosermo, Kec. Wonocolo, Kota SBY, Jawa Timur 60297</h6>
                <h6><i class="fas fa-envelope"></i> &nbsp;&nbsp;info@dexa-arfindopratama.com</h6>
                <h6><i class="fas fa-phone"></i> &nbsp;+62-31 998852022</h6>
              </ul>
            </div>
          </div>
        </div>
    ...
    <!-- Back to top button -->
    <a id="btn-back-to-top" href="#" class="btn" role="button"><i class="fas fa-chevron-up"></i></a>
  </div>
  <!-- Vendor Scripts -->
