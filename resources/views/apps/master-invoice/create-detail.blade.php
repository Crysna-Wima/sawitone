            ...
            <div class="col-12 col-md-4 col-lg-4">
                <div class="card">
                    ...
                    <div class="collapse" id="mycard-collapse">
                        ...
                        <form id="form_submit" action="/apps/receiving-order/create/store-update" method="POST"
                            autocomplete="off">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="fc_userid" id="fc_userid" type="text" class="form-control"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="" type="text"
                                                value="{{ $ro_mst->pomst->supplier->supplier_tax_code->fv_description }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" data-date-format="dd-mm-yyyy">
                                                <input type="text" class="form-control datepicker"
                                                    name="fd_inv_releasedate" id="fd_inv_releasedate"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" data-date-format="dd-mm-yyyy">
                                                <input type="text" id="fd_inv_agingdate" class="form-control datepicker"
                                                    name="fd_inv_agingdate" value="{{ $inv_mst->fd_inv_agingdate }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $tipe_cabang->pomst->supplier->supplier_typebranch->fv_description }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $tipe_cabang->pomst->supplier->supplier_type_business->fv_description }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-4 col-md-4 col-lg-4">
                                ...
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $legal_status->pomst->supplier->fn_supplierAgingAR }}" readonly>
                                    </div>
                                </div>
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $legal_status->pomst->supplier->supplier_legal_status->fv_description }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-4 col-md-4 col-lg-4">
                                ...
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label>Hutang</label>
                                        <input type="text" class="form-control"
                                            value="{{ $ro_mst->pomst->supplier->fm_supplierAR }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control format-rp" name="fm_servpay"
                                                id="fm_servpay" value="{{ $inv_mst->fm_servpay }}" required>
                                        </div>
                                    </div>
                                </div>
