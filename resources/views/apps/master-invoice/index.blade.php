                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="incoming" role="tabpanel"
                                ...
                                <div class="text-right mb-3">
                                    ...
                                    @if ($fc_rono)
                                        <a href="/apps/master-invoice/create/{{ base64_encode($fc_rono) }}"
                                            class="btn btn-success"><i class="fa fa-plus mr-1"></i> Tambah
                                            Invoice</a>
                                    @else
                                            ...
                                            <div class="flex-row-item" style="margin-right: 30px">
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    ...
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fn_invdetail_outgoing">0,00</p>
                                                </div>
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    <p class="text-secondary flex-row-item" style="font-size: medium">
                                                        Disc. Total</p>
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fm_disctotal_outgoing">0,00</p>
                                                </div>
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    <p class="text-secondary flex-row-item" style="font-size: medium">
                                                        Total</p>
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fm_netto_outgoing">0,00</p>
                                                </div>
                                            </div>
                                            <div class="flex-row-item">
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    <p class="text-secondary flex-row-item" style="font-size: medium">
                                                        Pelayanan</p>
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fm_servpay_outgoing">0,00</p>
                                                </div>
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    <p class="text-secondary flex-row-item" style="font-size: medium">
                                                        Pajak</p>
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fm_tax_outgoing">0,00</p>
                                                </div>
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    ...
                                                    <p class="text-success flex-row-item text-right"
                                                        ...
                                                        id="fm_brutto_outgoing">Rp. 0,00</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="flex-row-item" style="margin-right: 30px">
                                                ...
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    <p class="text-secondary flex-row-item" style="font-size: medium">
                                                        Terbayar</p>
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-size: medium" id="fm_paidvalue_outgoing">0,00</p>
                                                </div>
                                            </div>
                                            <div class="flex-row-item">
                                                <div class="d-flex">
                                                ...
                                                <div class="d-flex" style="gap: 5px; white-space: pre">
                                                    ...
                                                    <p class="text-success flex-row-item text-right"
                                                        style="font-weight: bold; font-size:medium" id="sisa_outgoing">Rp.
                                                        0,00</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body" style="height: 215px">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-row-item" style="margin-right: 30px">
                                                ...
                                                <input type="text" name="fm_paidvalue" id="fm_paidvalue_input" hidden>
                                            </div>
                                            <div class="flex-row-item">
                                                <div class="d-flex">
                                                    <p class="flex-row-item"></p>
