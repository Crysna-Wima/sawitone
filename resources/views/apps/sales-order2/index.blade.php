                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>Tanggal : 05/12/2022</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_member_branchtype" id="fc_member_branchtype" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Tipe Bisnis</label>
                                    <input type="text" class="form-control" name="fc_membertypebusiness" id="fc_membertypebusiness" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fc_memberlegalstatus" id="fc_memberlegalstatus" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
...
<script>
    ...
    function table_customer(){
        var tb = $('#tb_customer').DataTable({
            ...
            rowCallback : function(row, data){
                $('td:eq(7)', row).html(`
                    <button type="button" class="btn btn-success btn-sm mr-1" onclick="detailCustomer('${data.fc_membercode}')"><i class="fa fa-check"></i> Pilih</button>
                `);
            }
        });
    }
    ...
    function table_stock(){
        var tb = $('#tb_stock').DataTable({
            ...
            rowCallback : function(row, data){
                $('td:eq(6)', row).html(`
                    <button type="button" class="btn btn-success btn-sm mr-1" onclick="detailStock('${data.fc_stockcode}')"><i class="fa fa-check"></i> Pilih</button>
                `);
            }
        });
    }
    ...
    function detailCustomer($id){
        $("#modal_loading").modal('show');
        $.ajax({
            url : "/master/get-data-where-field-id-first/Customer/fc_membercode/" + $id,
            type: "GET",
            dataType: "JSON",
            success: function(response){
                var data = response.data;
