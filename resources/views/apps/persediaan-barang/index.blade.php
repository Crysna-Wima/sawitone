                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active show" id="dexa-tab" data-toggle="tab" href="#dexa"
                                    role="tab" aria-controls="dexa" aria-selected="true">Gudang Internal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="gudanglain-tab" data-toggle="tab" href="#gudanglain" role="tab"
                                    aria-controls="gudanglain" aria-selected="false">Gudang Eksternal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="semua-tab" data-toggle="tab" href="#semua" role="tab"
                                    aria-controls="semua" aria-selected="false">Seluruh Persediaan</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="dexa" role="tabpanel"
                                aria-labelledby="dexa-tab">
...
@section('modal')
    ...
    <div class="modal fade" role="dialog" id="modal_inventory_gudanglain" data-keyboard="false"
