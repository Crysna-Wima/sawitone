                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-lg-12 text-right">
                                <form id="form_cancel" action="/apps/master-purchase-order/cancel_po" method="PUT">
                                    ...
                                    @if (($po_master->fc_postatus == 'CL') || ($po_master->fc_postatus == 'C') || ($po_master->fc_postatus == 'CC') || ($po_master->fc_postatus == 'S'))
...
<script>
    ...
    var tb = $('#po_detail').DataTable({
        ...
        rowCallback: function(row, data) {
            ...
            if (data['fc_status'] == 'W') {
                $('td:eq(9)', row).html(
                    '<span class="badge badge-primary"><i class="fa fa-hourglass"></i> Menunggu</span>');
