...
<div class="section-body">
    <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-12 place_detail">
            <form id="form_submit_custom" action="/apps/receiving-order/create/submit-ro" method="POST" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-body">
...
<div class="modal fade" role="dialog" id="modal_select" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_submit_custom" action="/apps/receiving-order/create/insert-item" method="post" autocomplete="off">
