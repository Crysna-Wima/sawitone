                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $ro_master->fc_sjno }}" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $ro_master->fc_receiver }}" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" data-date-format="dd-mm-yyyy">
                                                ...
                                                <input type="text" id="" class="form-control datepicker"
                                                    name="fd_roarivaldate" value="{{ $ro_master->fd_roarivaldate }}"
                                                    required readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-5">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <input type="text" name="fc_address_loading" class="form-control"
                                ...
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="fc_stockcode" class="form-control"
                                                name="fc_stockcode" required>
                                            <input type="text" id="fc_pono" class="form-control" name="fc_pono"
                                                hidden>
                                            <input type="text" id="fc_namepack" class="form-control"
                                                name="fc_namepack" hidden>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="fc_nameshort" class="form-control"
                                                name="fc_nameshort" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label>Batch</label>
                                        <input type="text" id="fc_batch" class="form-control" name="fc_batch"
                                            required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label>Qty</label>
                                        <input type="number" min="0" class="form-control" name="fn_qty_ro"
                                            id="fn_qty_ro">
                                        <input type="number" min="0" class="form-control" name="fn_qty_ro"
                                            id="fn_qty_po" hidden>
                                    </div>
                                ...
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" data-date-format="dd-mm-yyyy">
                                            ...
                                            <input type="text" id="fd_expired_date" class="form-control datepicker"
                                                name="fd_expired_date" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 col-lg-4">
