...
<div class="section-body">
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="fc_membercode" name="fc_membercode" value="{{ $data->fc_suppliercode }}" readonly>
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" disabled onclick="click_modal_supplier()" type="button"><i class="fa fa-search"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="font-size: 12px" value="{{ $data->supplier->supplier_tax_code->fv_description }} ({{ $data->supplier->supplier_tax_code->fc_action }}%)" readonly>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>NPWP</label>
                                    <input type="text" class="form-control" value="{{ $data->supplier->fc_supplierNPWP }}" name="fc_membernpwp_no" id="fc_membernpwp_no" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" value="{{ $data->supplier->fc_suppliername1 }}" name="fc_suppliername1" id="fc_suppliername1" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $data->supplier->fn_supplierAgingAR }}" readonly>
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Hutang</label>
                                    <input type="text" class="form-control" value="{{ $data->supplier->fm_supplierAR }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12 col-md-12 col-lg-6 place_detail">
            <div class="card">
                <div class="card-body" style="padding-top: 30px!important;">
                    <form id="add_item" action="/apps/purchase-order/detail/store-update" method="POST" autocomplete="off">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fc_stockcode" name="fc_stockcode" readonly hidden>
                                        <div class="input-group-append">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <div class="input-group format-rp">
                                    ...
                                    <input type="text" id="fm_po_price" class="form-control" name="fm_po_price" onkeyup="return onkeyupRupiah(this.id)" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-5">
                                <div class="form-group">
                                    <label>Qty</label>
                                    <div class="form-group">
                                        <input type="number" min="0" class="form-control" name="fn_po_qty" id="fn_po_qty">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12 col-md-12 col-lg-12 place_detail">
            <div class="card">
                <div class="card-body" style="padding-top: 30px!important;">
                    <form id="form_submit" action="/apps/purchase-order/detail/received-update/{{ $data->fc_pono }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input type="text" id="fd_podateinputuser" class="form-control datepicker" name="fd_podateinputuser" required>
                                        @else
                                        <input type="text" id="fd_podateinputuser" class="form-control datepicker" name="fd_podateinputuser" value="{{ $data->fd_podateinputuser }}" required>
                                        @endif
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group" data-date-format="dd-mm-yyyy">
                                        ...
                                        <input type="text" id="fd_poexpired" class="form-control datepicker" name="fd_poexpired" required readonly>
                                        @else
                                        <input type="text" id="fd_poexpired" class="form-control datepicker" name="fd_poexpired" value="{{ $data->fd_poexpired }}" required readonly>
                                        @endif
                            ...
                            <div class="col-12 col-md-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group format-rp">
                                        ...
                                        <input type="text" class="form-control format-rp" name="fm_servpay" id="fm_servpay" value="0" fdprocessedid="hgh1fp" onkeyup="return onkeyupRupiah(this.id);" required>
                                        @else
                            ...
                            <div class="col-12 col-md-12 col-lg-3">
                                ...
                                <select class="form-control select2" name="fc_membername1" id="fc_membername1">
                                </select>
                            </div>
                            <div class="col-12 col-md-12 col-lg-3">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === 200) {
                    ...
                    $("#fc_membername1").append(`<option value="DEXA" selected readonly>DEXA</option>`);
