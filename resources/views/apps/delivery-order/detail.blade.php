                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" id="fc_sotransport"
                                                name="fc_sotransport" value="{{ $data->fc_sotransport }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label>Piutang</label>
                                        <input type="text" class="form-control"
                                            value="Rp. {{ number_format($data->customer->fm_memberAP, 0, ',', '.') }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
